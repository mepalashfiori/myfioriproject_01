		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Git Demo hands on",
									"targetURL": "#GitDemohandson-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"GitDemohandson-display": {
								"semanticObject": "GitDemohandson",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mepalash.MyGitDemo",
									"url": sap.ui.require.toUrl("mepalash/MyGitDemo")
								}
							}
						}
					}
